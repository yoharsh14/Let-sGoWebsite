...
export default function Footer() {
  return (
    <BackgroundVideo src="/footer.mp4" className="w-full  text-black font-bold">
      <div className="h-full overflow-hidden bg-footerBg backdrop-blur-md rounded-lg desktop:text-2xl md:text-[4rem] sm:text-[2rem] mobile:text-[0.5rem] mobile:p-2">
        <div className="flex justify-center m-auto items-start desktop:gap-20 desktop:pt-10 desktop:pb-14 container sm:text-sm sm:gap-10 mobile:pb-0 mobile:gap-[10px]">
