      ...
      <div className="bg-[radial-gradient(ellipse_at_center,#020024_40%,#0303_60%,#000000_69%)] flex flex-col justify-center items-center gap-6 bg-">
        ...
        <div className="w-3/4 h-svh flex justify-center items-center m-auto gap-4 ">
          <div className="flex flex-col w-1/3 h-[90%] gap-4">
            <div className=" h-1/2  rounded-xl flex flex-col justify-center gap-2 items-center overflow-hidden">
              <h1>Experties</h1>
              <div className="">
          ...
          <div className=" h-full  rounded-xl flex flex-col justify-center gap-2 items-center overflow-hidden">
            <h1> Why Us</h1>
          ...
          <div className="flex flex-col w-1/3 h-[90%] gap-4">
            ...
            <div className="h-[60%]  rounded-xl flex flex-col justify-center gap-2 items-center overflow-hidden">
              <h1>Trust</h1>
